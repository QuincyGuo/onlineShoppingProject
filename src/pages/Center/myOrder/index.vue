    ...
    <div class="order-content">
      ...
      <div class="orders">
        ...
        <table class="order-item"
          ...
          <tbody>
            <!-- 订单里有几个商品就有几行；后面的总订单的数据进行单元格合并即可 -->
            <tr v-for="(cart, index) in order.orderDetailList"
              ...
              <!-- 这里竖向合并的单元格是排在左边的商品数量的单元格数；v-if是只在第一行时有这行单元格，下面的行就不再有这些行单元格，因为被第一行的合并了 -->
